...
function itemCreate(equipment, description, supplier, category, quantity, url, price) {
  itemdetail = {
    equipment: equipment,
...
function categoryCreate(name, description, url) {
...
function supplierCreate(name, email, website, telephone) {
  supplierdetail = { 
    name: name,
    email: email,
    website: website,
